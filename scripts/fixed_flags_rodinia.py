...
#        for benchmark in os.listdir(spec_dir):
        for benchmark in ['backprop', 'hotspot', 'kmeans', 'srad', 'streamcluster']:
            benchmark_dir = rodinia_dir + "/" + benchmark
            ...
            if os.path.isdir(benchmark_dir):
                ...
                for i in range(0, samples):
                    ...
                    success = True # Rodinia doesn't have any validation scripts
