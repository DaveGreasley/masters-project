...
NUMBER=367
NAME=imagick
SOURCES= magick_accelerate.c magick_animate.c magick_annotate.c \
	 magick_artifact.c magick_attribute.c magick_blob.c magick_cache.c \
	 magick_cache-view.c magick_cipher.c magick_client.c magick_coder.c \
	 magick_color.c magick_colormap.c magick_colorspace.c magick_compare.c \
	 magick_composite.c magick_compress.c magick_configure.c \
	 magick_constitute.c magick_decorate.c magick_delegate.c \
	 magick_deprecate.c magick_display.c magick_distort.c magick_draw.c \
	 magick_effect.c magick_enhance.c magick_exception.c magick_feature.c \
	 magick_fourier.c magick_fx.c magick_gem.c magick_geometry.c \
	 magick_hashmap.c magick_histogram.c magick_identify.c magick_image.c \
	 magick_layer.c magick_list.c magick_locale.c magick_log.c magick_magic.c \
	 magick_magick.c magick_matrix.c magick_memory.c magick_mime.c \
	 magick_module.c magick_monitor.c magick_montage.c magick_morphology.c \
	 magick_option.c magick_paint.c magick_pixel.c magick_policy.c \
	 magick_prepress.c magick_profile.c magick_property.c magick_quantize.c \
	 magick_quantum.c magick_quantum-export.c magick_quantum-import.c \
	 magick_random.c magick_registry.c magick_resample.c magick_resize.c \
	 magick_resource.c magick_segment.c magick_semaphore.c magick_shear.c \
	 magick_signature.c magick_splay-tree.c magick_static.c \
	 magick_statistic.c magick_stream.c magick_string.c magick_threshold.c \
	 magick_timer.c magick_token.c magick_transform.c magick_type.c \
	 magick_utility.c magick_version.c magick_xml-tree.c coders_tga.c \
	 filters_analyze.c wand_convert.c wand_drawing-wand.c wand_magick-image.c \
	 wand_magick-property.c wand_magick-wand.c wand_mogrify.c \
	 wand_pixel-iterator.c wand_pixel-wand.c wand_wand.c utilities_convert.c
EXEBASE=convert
NEED_MATH=yes
BENCHLANG=C
ONESTEP=
