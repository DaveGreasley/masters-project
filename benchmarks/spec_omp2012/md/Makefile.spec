...
NUMBER=350
NAME=md
SOURCES= md_types.f md_globals.f md_comm_ser.f md.F input1.F inital.f \
	 randnums.f int_control.f g.f s.f perf_stubs.f dwallclock00.f \
	 int_nn_direct.f int_ion_pure_direct.f int_ion_mix_direct.f
EXEBASE=md_omp
NEED_MATH=
BENCHLANG=F
ONESTEP=
...
CXX              = g++
FC               = gfortran
FOPTIMIZE        = -fno-strict-aliasing -fno-range-check -ffree-form
FPBASE           = yes
...
path             = /home/dave/Documents/project/benchmarks/omp2012-1.0/benchspec/OMP2012/350.md
plain_train      = 0
platform         = 
power            = 0
preenv           = 1
...
srcalt           = 
srcdir           = src
srcsource        = /home/dave/Documents/project/benchmarks/omp2012-1.0/benchspec/OMP2012/350.md/src
stagger          = 10
...
voltage_range    = 
worklist         = list
OUTPUT_RMFILES   = md.log.01228004000
